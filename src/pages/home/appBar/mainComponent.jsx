...
const ResponsiveDrawer = (props) => {
    ...
    // ----------------------------------------------------------
    const [selectedIndex_2, setSelectedIndex_2] = useState(null);
    ...
    const menuItems_one = [
        ...
        { value: 2, name: 'Buy Form' },
        { value: 3, name: 'Sell Form' },
        { value: 4, name: 'List' },
        { value: 5, name: 'Profile' }
    ];
    // -------------------------------------------------
    const menuItems_two = [
        { value: 6, name: 'Broker Form' },
        { value: 7, name: 'Stock Name' },
        { value: 8, name: 'Extra Charges' },
    ...
    const renderForm = () => {
        ...
        if (count_2 !== null && count_2 !== undefined) {
            switch (count_2) {
                case 6: return <BrokerForm />;
                case 7: return <StockName />;
                case 8: return <ExtraCharges />;
                default: return null;
            }
        }
